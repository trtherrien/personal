...
{   
    ...
    MainMenuViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"MainMenuViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(MainMenuViewController *)viewController];
